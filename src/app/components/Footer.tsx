    ...
    <footer>
      <div>
        <section className="left">
          ...
          <div className="nav">
            <ul>
              <li className="homeBtn" onClick={() => navigate("/")}>
                Home
              </li>
          ...
          <div className="social">
            <ul>
              <li>
                <img src={"/assets/shared/desktop/facebook.svg"} alt="logo" />
              </li>
              <li>
                <img src={"/assets/shared/desktop/youtube.svg"} alt="logo" />
              </li>
              <li>
                <img src={"/assets/shared/desktop/twitter.svg"} alt="logo" />
              </li>
              <li>
                <img src={"/assets/shared/desktop/pinterest.svg"} alt="logo" />
              </li>
              <li>
                <img src={"/assets/shared/desktop/instagram.svg"} alt="logo" />
              </li>
            </ul>
          </div>
        </section>
